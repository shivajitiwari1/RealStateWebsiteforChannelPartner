        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://wa.me/919999649937" target="_blank" rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                ...
                <a href="tel:+919999649937" className="text-sm text-gray-400 hover:text-white transition-colors font-body">+91 99996 49937</a>
              </li>
              <li className="flex items-start gap-2.5">
                <svg className="w-4 h-4 text-brand-blue mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
