...
const CITIES = [
  { name: "Noida",        slug: "noida",         desc: "IT hub & modern townships",    img: "/images/cities/noida.jpg" },
  { name: "Greater Noida",slug: "greater-noida", desc: "Planned city, new projects",   img: "/images/cities/greater-noida.jpg" },
  { name: "Gurgaon",      slug: "gurgaon",       desc: "Corporate & luxury living",    img: "/images/cities/gurgaon.jpg" },
  { name: "Faridabad",    slug: "faridabad",     desc: "Affordable family homes",      img: "/images/cities/faridabad.jpg" },
  { name: "Ghaziabad",    slug: "ghaziabad",     desc: "Connected & growing fast",     img: "/images/cities/ghaziabad.jpg" },
  { name: "Delhi",        slug: "delhi",         desc: "Prime urban properties",       img: "/images/cities/delhi.jpg" },
];
...
const CATEGORIES = [
  {
    ...
    img: "/images/cat/residential.jpg",
    icon: (
  ...
  return (
    <>
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        {/* JS-driven slideshow — reliable cross-fade between local images */}
        <HeroSlideshow />
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-brand-accent rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl opacity-60 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-50 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl opacity-80 pointer-events-none" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            {/* Left: heading */}
            <div>
              <p className="text-xs font-body font-semibold text-brand-blue uppercase tracking-widest mb-3">Our Promise</p>
              <h2 className="font-display text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-5">
                Why Families Trust<br />
                <span className="text-brand-blue">PropTech NCR</span>
              </h2>
              <p className="text-gray-500 font-body text-base leading-relaxed mb-8">
                We&apos;re not just listing properties — we&apos;re building relationships. Every family deserves the right home, and we help you find it without the stress.
              </p>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.title} className="flex gap-5 items-start bg-gray-50 hover:bg-brand-accent rounded-2xl p-5 transition-colors duration-300 group cursor-default">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-brand-blue text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-300">
                    {item.icon}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-body font-bold text-brand-blue/50 tracking-widest">{item.num}</span>
